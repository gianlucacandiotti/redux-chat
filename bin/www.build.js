...
/***/ function(module, exports, __webpack_require__) {
	...
	var debug = __webpack_require__(119)('redux-chat:server');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _hoffman = __webpack_require__(9);

	var _hoffman2 = _interopRequireDefault(_hoffman);

	var _connectHistoryApiFallback = __webpack_require__(10);
	...
	app.engine('dust', _hoffman2.default.__express());
...
/***/ function(module, exports, __webpack_require__) {
	...
	var loadRoutes = function loadRoutes(app) {
	  ...
	  files.filter(function (file) {
	    ...
	    var router = __webpack_require__(13)("./" + file);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _pathsToRegex = __webpack_require__(118);

	var _pathsToRegex2 = _interopRequireDefault(_pathsToRegex);
	...
	router.get((0, _pathsToRegex2.default)(paths), function (req, res, next) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Home = function Home(props) {
	  ...
	  return _react2.default.createElement(
	    'div',
	    null,
	    _react2.default.createElement(_NavBar2.default, { navRight: navRight }),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _NavLink = __webpack_require__(107);
	...
	var NavBar = function (_Component) {
	  ...
	  (0, _createClass3.default)(NavBar, [{
	    ...
	    value: function render() {
	      var navRight = this.props.navRight;
	      var isNavOpen = this.state.isNavOpen;


	      console.log(_NavBar2.default.logo);
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              'a',
	              { className: 'nav-item' },
	              _react2.default.createElement('img', { src: _logo2.default, className: _NavBar2.default.logo, alt: 'Redux logo' })
	            )
	          ),
	          _react2.default.createElement(
	            'span',
	...
	NavBar.propTypes = {
	  navRight: _react.PropTypes.arrayOf(_react.PropTypes.shape({
	    text: _react.PropTypes.string.isRequired,
	    link: _react.PropTypes.string.isRequired,
	    index: _react.PropTypes.bool
	  }).isRequired)
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(37)(IteratorPrototype, __webpack_require__(77)('iterator'), function(){ return this; });
	...
	module.exports = {
	  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
	    function(test, buggy, set){
	      try {
	        set = __webpack_require__(35)(Function.call, __webpack_require__(95).f(Object.prototype, '__proto__').set, 2);
	        set(test, []);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var NavLink = function NavLink(props) {
	  return _react2.default.createElement(_reactRouter.Link, (0, _extends3.default)({}, props, { activeClassName: 'is-active' }));
	};
...
/***/ function(module, exports) {
	...
	var pathsToRegex = function pathsToRegex(paths) {
	  return new RegExp(paths.map(function (e) {
	    return '(^\\' + e + '$)';
	  }).join('|'));
	};

	exports.default = pathsToRegex;
